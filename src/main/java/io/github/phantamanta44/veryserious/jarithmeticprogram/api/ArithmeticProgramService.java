...
import io.github.phantamanta44.veryserious.jarithmeticprogram.impl.MutableArithmeticOperationFactoryWrapper;
...
public abstract class ArithmeticProgramService {
    ...
    public static <I extends Number, O extends Number> IArithmeticOperationFactory getOperation(final String operationName) {
